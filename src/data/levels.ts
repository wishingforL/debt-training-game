...
export const PRACTICE_LEVELS: LevelData[] = [
  caseData({
    ...
    fields: [
      moneyField("unsecuredDebt", "신용대출", "채무현황", 3500, "00카드 카드론은 16,000천원, 00카드 카드대금은 5,000천원, 00은행 신용대출은 14,000천원"),
  ...
  caseData({
    ...
    fields: [
      housingField("임차", "전세보증금 100,000천원 집에 살고 있습니다."),
      moneyField("jeonseDeposit", "전세보증금", "주거", 10000, "전세보증금 100,000천원 집에 살고 있습니다."),
      moneyField("securedDebt", "담보대출", "채무현황", 10300, "00저축은행 보증서담보대출은 13,000천원 남아 있으며, 00은행 전세담보대출은 90,000천원"),
      moneyField("unsecuredDebt", "신용대출", "채무현황", 3500, "00은행 신용대출은 24,000천원, 00카드 카드대금은 11,000천원"),
  ...
  caseData({
    ...
    fields: [
      ...
      moneyField("unsecuredDebt", "신용대출", "채무현황", 10000, "00은행 신용대출은 55,000천원, 00카드 카드대금은 20,000천원, 00저축은행 신용대출은 25,000천원"),
      ...
      moneyField("securedDebt", "담보대출", "채무현황", 1000, "00캐피탈 차량담보대출은 10,000천원"),
  ...
  caseData({
    ...
    fields: [
      ...
      numberField("dependent.spouse", "배우자", "가족", 1, "명", "배우자는 현재 소득이 없고 함께 거주하고 있으며"),
      moneyField("unsecuredDebt", "신용대출", "채무현황", 7000, "00카드 카드론은 25,000천원, 00은행 신용대출은 30,000천원, 00저축은행 신용대출은 15,000천원"),
      ...
      moneyField("securedDebt", "담보대출", "채무현황", 9500, "00은행 주택담보대출은 95,000천원"),
  ...
  caseData({
    ...
    systemScreens: ["소득", "가족", "재산", "채무현황"],
    fields: [
      moneyField("unsecuredDebt", "신용대출", "채무현황", 6300, "00은행 신용대출은 30,000천원, 00카드 카드대금은 16,000천원, 00캐피탈 신용대출은 17,000천원"),
      ...
      moneyField("securedDebt", "담보대출", "채무현황", 6000, "00은행 주택담보대출은 60,000천원"),
