...
export const PRACTICE_LEVELS: LevelData[] = [
  caseData({
    ...
    fields: [
      moneyField("unsecuredDebt.cardLoan", "카드론", "채무현황", 1600, "00카드 카드론은 16,000천원"),
      ...
      moneyField("unsecuredDebt.cardDebt", "카드대금", "채무현황", 500, "00카드 카드대금은 5,000천원"),
  ...
  caseData({
    ...
    fields: [
      housingField("임차", "전세보증금 100,000천원 집에 살고 있습니다."),
      moneyField("jeonseDeposit", "전세보증금", "주거", 10000, "전세보증금 100,000천원 집에 살고 있습니다."),
      moneyField("securedDebt.guarantee", "보증서담보대출", "채무현황", 1300, "00저축은행 보증서담보대출은 13,000천원"),
      ...
      moneyField("unsecuredDebt.cardDebt", "카드대금", "채무현황", 1100, "00카드 카드대금은 11,000천원"),
      moneyField("securedDebt.jeonse", "전세담보대출", "채무현황", 9000, "00은행 전세담보대출은 90,000천원"),
  ...
  caseData({
    ...
    fields: [
      ...
      moneyField("unsecuredDebt.bankLoan", "은행 신용대출", "채무현황", 5500, "00은행 신용대출은 55,000천원"),
      ...
      moneyField("unsecuredDebt.cardDebt", "카드대금", "채무현황", 2000, "00카드 카드대금은 20,000천원"),
      numberField("overdueDays", "연체일수", "채무현황", 128, "일", "사업 실패 후 128일째 연체 중입니다."),
      moneyField("securedDebt.vehicle", "차량담보대출", "채무현황", 1000, "00캐피탈 차량담보대출은 10,000천원"),
      moneyField("unsecuredDebt.savingsLoan", "저축은행 신용대출", "채무현황", 2500, "00저축은행 신용대출은 25,000천원"),
  ...
  caseData({
    ...
    fields: [
      ...
      numberField("dependent.spouse", "배우자", "가족", 1, "명", "배우자는 현재 소득이 없고 함께 거주하고 있으며"),
      moneyField("unsecuredDebt.cardLoan", "카드론", "채무현황", 2500, "00카드 카드론은 25,000천원"),
      ...
      moneyField("unsecuredDebt.bankLoan", "은행 신용대출", "채무현황", 3000, "00은행 신용대출은 30,000천원"),
      numberField("overdueDays", "연체일수", "채무현황", 22, "일", "카드값 때문에 22일째 연체 중입니다."),
      booleanField("homeOwned", "공동명의 주택", "재산", "현재 배우자와 본인 공동명의 집에 거주하고 있고"),
      moneyField("unsecuredDebt.savingsLoan", "저축은행 신용대출", "채무현황", 1500, "00저축은행 신용대출은 15,000천원"),
      moneyField("securedDebt.home", "주택담보대출", "채무현황", 9500, "00은행 주택담보대출은 95,000천원"),
  ...
  caseData({
    ...
    fields: [
      ...
      moneyField("unsecuredDebt.cardDebt", "카드대금", "채무현황", 1600, "00카드 카드대금은 16,000천원"),
      ...
      moneyField("securedDebt.home", "주택담보대출", "채무현황", 6000, "00은행 주택담보대출은 60,000천원"),
      numberField("dependent.mother", "70세 모친", "가족", 1, "명", "70세 모친도 별도 소득 없이 함께 거주하고 있습니다."),
      moneyField("unsecuredDebt.capitalLoan", "캐피탈 신용대출", "채무현황", 1700, "00캐피탈 신용대출은 17,000천원"),
