...
export const PRACTICE_LEVELS: LevelData[] = [
  caseData({
    ...
    scenario: [
      ...
      "월 3,100천원 벌고 있습니다.",
      "부친은 59세이며 교직원연금 월 3,000천원을 수령하고 그 소득으로 생활하고 있습니다.",
    ...
    decoys: [
      {
        clue: "부친은 59세이며 교직원연금 월 3,000천원을 수령하고 그 소득으로 생활하고 있습니다.",
        label: "부친",
        reason: "부친은 59세이고 본인 소득으로 생활하므로 부양가족으로 선택하지 않습니다.",
        screen: "가족",
      },
    ],
    systemScreens: ["소득", "가족", "특이사항", "채무현황", "주거", "재산"],
    fields: [
      moneyField("unsecuredDebt.cardLoan", "카드론", "채무현황", 1600, "00카드 카드론이 16,000천원 남아 있습니다."),
      choiceField("residenceArea", "거주지역", "주거", "경기도", "경기도에 거주하고 있습니다."),
      choiceField(
        "debtReason",
        "채무발생 사유",
        "특이사항",
      ...
      moneyField("income", "월 소득", "소득", 310, "월 3,100천원 벌고 있습니다."),
      moneyField("unsecuredDebt.cardDebt", "카드대금", "채무현황", 500, "00카드 카드대금이 5,000천원 남아 있습니다."),
      housingField("임차", "보증금 10,000천원, 월세 800천원으로 살고 있습니다."),
      moneyField("deposit", "보증금", "주거", 1000, "보증금 10,000천원, 월세 800천원으로 살고 있습니다."),
      moneyField("monthlyRent", "월세", "주거", 80, "보증금 10,000천원, 월세 800천원으로 살고 있습니다."),
      numberField("dependent.spouse", "배우자", "가족", 1, "명", "배우자는 현재 소득이 없고 함께 거주하고 있습니다."),
      numberField("overdueDays", "연체일수", "채무현황", 28, "일", "카드값 때문에 28일째 연체 중입니다."),
      moneyField("unsecuredDebt.bankLoan", "신용대출", "채무현황", 1400, "00은행 신용대출이 14,000천원 남아 있습니다."),
      booleanField("hasVehicle", "차량", "재산", "본인 명의 차량 1대가 있습니다."),
      moneyField("vehicleValue", "차량 시세", "재산", 1100, "차량 시세는 11,000천원입니다."),
    ],
    supportType: "신속채무조정",
  }),
  caseData({
    ...
    scenario: [
      ...
      "동생이 함께 거주 중이나 월 2,600천원의 소득이 있고 그 소득으로 생활하고 있습니다.",
    ...
    decoys: [
      {
        clue: "동생이 함께 거주 중이나 월 2,600천원의 소득이 있고 그 소득으로 생활하고 있습니다.",
        label: "동생",
    ...
    fields: [
      housingField("임차", "전세보증금 100,000천원 집에 살고 있습니다."),
      moneyField("jeonseDeposit", "전세보증금", "주거", 10000, "전세보증금 100,000천원 집에 살고 있습니다."),
      moneyField("securedDebt.guarantee", "보증서담보대출", "채무현황", 1300, "00저축은행 보증서담보대출이 13,000천원 남아 있습니다."),
      choiceField(
        "debtReason",
        "채무발생 사유",
        "특이사항",
      ...
      moneyField("unsecuredDebt.bankLoan", "신용대출", "채무현황", 2400, "00은행 신용대출이 24,000천원 남아 있습니다."),
      numberField("dependent.mother", "모친", "가족", 1, "명", "모친은 72세이고 별도 소득 없이 함께 거주하고 있습니다."),
      moneyField("securedPayment.jeonse", "담보 이자", "채무현황", 25, "전세담보대출 이자로 매월 250천원씩 내고 있습니다."),
      moneyField("income", "월 소득", "소득", 280, "월 2,800천원 벌고 있습니다."),
      numberField("overdueDays", "연체일수", "채무현황", 78, "일", "대출금 때문에 78일째 연체 중입니다."),
      moneyField("unsecuredDebt.cardDebt", "카드대금", "채무현황", 1100, "00카드 카드대금이 11,000천원 남아 있습니다."),
      moneyField("securedDebt.jeonse", "전세담보대출", "채무현황", 9000, "00은행 전세담보대출이 90,000천원 남아 있습니다."),
  ...
  caseData({
    ...
    systemScreens: ["소득", "가족", "특이사항", "재산", "채무현황"],
    fields: [
      booleanField("hasVehicle", "차량", "재산", "본인 명의 차량 시세는 13,000천원입니다."),
      moneyField("vehicleValue", "차량 시세", "재산", 1300, "본인 명의 차량 시세는 13,000천원입니다."),
      choiceField("debtReason", "채무발생 사유", "특이사항", "폐업 및 사업 실패", "폐업 이후 운영자금 대출을 갚지 못해 연체가 시작되었습니다."),
      moneyField("unsecuredDebt.bankLoan", "은행 신용대출", "채무현황", 5500, "00은행 신용대출이 55,000천원 남아 있습니다."),
      moneyField("securedPayment.vehicle", "담보 원리금", "채무현황", 32, "차량담보대출 원리금으로 매월 320천원씩 내고 있습니다."),
      moneyField("income", "월 소득", "소득", 380, "월 3,800천원 벌고 있습니다."),
      moneyField("unsecuredDebt.cardDebt", "카드대금", "채무현황", 2000, "00카드 카드대금이 20,000천원 남아 있습니다."),
      numberField("overdueDays", "연체일수", "채무현황", 128, "일", "사업 실패 후 128일째 연체 중입니다."),
      moneyField("securedDebt.vehicle", "차량담보대출", "채무현황", 1000, "00캐피탈 차량담보대출이 10,000천원 남아 있습니다."),
      moneyField("unsecuredDebt.savingsLoan", "저축은행 신용대출", "채무현황", 2500, "00저축은행 신용대출이 25,000천원 남아 있습니다."),
      numberField("dependent.childSupport", "미성년 자녀", "가족", 1, "명", "미성년 자녀에게 매월 양육비 400천원을 지급하고 있습니다."),
    ],
    supportType: "개인워크아웃",
  }),
  caseData({
    ...
    scenario: [
      ...
      "성인 자녀 1명은 월 2,000천원의 소득이 있고 그 소득으로 생활하고 있습니다.",
    ...
    decoys: [
      {
        clue: "성인 자녀 1명은 월 2,000천원의 소득이 있고 그 소득으로 생활하고 있습니다.",
        label: "성인 자녀",
    ...
    fields: [
      ...
      moneyField("unsecuredDebt.cardLoan", "카드론", "채무현황", 2500, "00카드 카드론이 25,000천원 남아 있습니다."),
      moneyField("income", "월 소득", "소득", 490, "월 4,900천원 벌고 있습니다."),
      numberField("dependent.highSchoolChild", "고등학생 자녀", "가족", 1, "명", "고등학생 자녀 1명과 함께 거주하고 있습니다."),
      moneyField("unsecuredDebt.bankLoan", "은행 신용대출", "채무현황", 3000, "00은행 신용대출이 30,000천원 남아 있습니다."),
      numberField("overdueDays", "연체일수", "채무현황", 22, "일", "카드값 때문에 22일째 연체 중입니다."),
      booleanField("homeOwned", "공동명의 주택", "재산", "배우자와 본인 공동명의 집에 거주하고 있습니다."),
      moneyField("unsecuredDebt.savingsLoan", "저축은행 신용대출", "채무현황", 1500, "00저축은행 신용대출이 15,000천원 남아 있습니다."),
      moneyField("securedDebt.home", "주택담보대출", "채무현황", 9500, "00은행 주택담보대출이 95,000천원 남아 있습니다."),
  ...
  caseData({
    ...
    scenario: [
      "이혼한 배우자는 별도 거주하고 있으나 생계가 어려워 일부 생활비를 도와주고 있습니다.",
      "00은행 신용대출이 30,000천원 남아 있습니다.",
    ...
    decoys: [
      {
        clue: "이혼한 배우자는 별도 거주하고 있으나 생계가 어려워 일부 생활비를 도와주고 있습니다.",
        label: "이혼한 배우자",
    ...
    fields: [
      ...
      choiceField(
        ...
        "채무발생 사유",
        "특이사항",
        "대학생 자녀 등록금 및 가족 생계비 부담",
        "대학생 자녀 등록금과 가족 생계비 부담으로 대출이 늘어났습니다.",
      ),
      booleanField("homeOwned", "거주 주택", "재산", "본인 명의 집에 거주하고 있습니다."),
      moneyField("income", "월 소득", "소득", 200, "월 2,000천원 벌고 있습니다."),
      moneyField("unsecuredDebt.cardDebt", "카드대금", "채무현황", 1600, "00카드 카드대금이 16,000천원 남아 있습니다."),
      numberField("dependent.collegeChild", "대학생 자녀", "가족", 1, "명", "대학생 자녀 1명은 소득 없이 함께 거주하고 있습니다."),
      numberField("overdueDays", "연체일수", "채무현황", 102, "일", "대출금 때문에 102일째 연체 중입니다."),
      moneyField("securedDebt.home", "주택담보대출", "채무현황", 6000, "00은행 주택담보대출이 60,000천원 남아 있습니다."),
      numberField("dependent.mother", "70세 모친", "가족", 1, "명", "70세 모친은 별도 소득 없이 함께 거주하고 있습니다."),
      moneyField("unsecuredDebt.capitalLoan", "캐피탈 신용대출", "채무현황", 1700, "00캐피탈 신용대출이 17,000천원 남아 있습니다."),
      moneyField("homeValue", "집 시세", "재산", 6800, "본인 명의 집 시세는 68,000천원입니다."),
