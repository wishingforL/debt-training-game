...
const LEVEL_CASES: LevelData[] = [
  ...
  caseData({
    ...
    fields: [
      ...
      moneyField("unsecuredDebt", "신용채무", "채무현황", 4500, "신용채무는 45,000천원입니다."),
      moneyField("securedDebt", "담보채무", "채무현황", 0, "담보채무는 없습니다."),
      booleanField("hasVehicle", "차량", "재산", "본인 명의 차량 한 대가 있습니다."),
      moneyField("vehicleValue", "차량 시세", "재산", 1200, "차량 추정 시세는 12,000천원입니다."),
    ],
    supportType: "신속채무조정",
  }),
  caseData({
    ...
    fields: [
      ...
      moneyField("unsecuredDebt", "신용채무", "채무현황", 5000, "신용채무는 50,000천원입니다."),
      moneyField("securedDebt", "담보채무", "채무현황", 0, "담보채무는 없습니다."),
      booleanField("hasVehicle", "차량", "재산", "본인 명의 차량 한 대가 있습니다."),
      moneyField("vehicleValue", "차량 시세", "재산", 1800, "차량 추정 시세는 18,000천원입니다."),
    ],
    supportType: "사전채무조정",
  }),
  caseData({
    ...
    fields: [
      ...
      moneyField("unsecuredDebt", "신용채무", "채무현황", 4800, "신용채무는 48,000천원입니다."),
      moneyField("securedDebt", "담보채무", "채무현황", 0, "담보채무는 없습니다."),
  ...
  caseData({
    ...
    scenario: [
      ...
      "카드값 때문에 20일째 연체 중입니다.",
      "신용채무는 38,000천원입니다.",
      "차량담보대출은 12,000천원 남아 있습니다.",
      "차량 할부금으로 매월 350천원씩 내고 있습니다.",
      "본인 명의 차량 한 대가 있습니다.",
      "차량 추정 시세는 16,000천원입니다.",
    ],
    systemScreens: ["소득", "가족", "재산", "채무현황"],
    fields: [
      ...
      numberField("dependents", "부양가족", "가족", 2, "명", "배우자와 자녀 1명을 부양하고 있습니다."),
      numberField("overdueDays", "연체일수", "채무현황", 20, "일", "카드값 때문에 20일째 연체 중입니다."),
      moneyField("unsecuredDebt", "신용채무", "채무현황", 3800, "신용채무는 38,000천원입니다."),
      moneyField("securedDebt", "담보채무", "채무현황", 1200, "차량담보대출은 12,000천원 남아 있습니다."),
      moneyField("securedPayment", "담보 원리금", "채무현황", 35, "차량 할부금으로 매월 350천원씩 내고 있습니다."),
      booleanField("hasVehicle", "차량", "재산", "본인 명의 차량 한 대가 있습니다."),
      moneyField("vehicleValue", "차량 시세", "재산", 1600, "차량 추정 시세는 16,000천원입니다."),
    ],
    supportType: "신속채무조정",
  }),
  caseData({
    ...
    scenario: [
      ...
      "신용채무는 45,000천원입니다.",
      "주택담보대출은 55,000천원 남아 있습니다.",
      "주택담보대출 원리금으로 매월 500천원씩 내고 있습니다.",
      "본인 명의 집에 거주하고 있습니다.",
      "집 추정 시세는 68,000천원입니다.",
    ],
    systemScreens: ["소득", "가족", "재산", "채무현황"],
    fields: [
      moneyField("income", "월 소득", "소득", 350, "월 3,500천원 벌고 있습니다."),
      ...
      moneyField("unsecuredDebt", "신용채무", "채무현황", 4500, "신용채무는 45,000천원입니다."),
      moneyField("securedDebt", "담보채무", "채무현황", 5500, "주택담보대출은 55,000천원 남아 있습니다."),
      moneyField("securedPayment", "담보 원리금", "채무현황", 50, "주택담보대출 원리금으로 매월 500천원씩 내고 있습니다."),
      booleanField("homeOwned", "거주 주택", "재산", "본인 명의 집에 거주하고 있습니다."),
      moneyField("homeValue", "집 시세", "재산", 6800, "집 추정 시세는 68,000천원입니다."),
    ],
    supportType: "사전채무조정",
  }),
  caseData({
    ...
    fields: [
      ...
      moneyField("unsecuredDebt", "신용채무", "채무현황", 4000, "신용채무는 40,000천원입니다."),
      moneyField("securedDebt", "담보채무", "채무현황", 8000, "주택담보대출은 80,000천원 남아 있습니다."),
      moneyField("securedPayment", "담보 원리금", "채무현황", 60, "주택담보대출 원리금으로 매월 600천원씩 내고 있습니다."),
      booleanField("homeOwned", "거주 주택", "재산", "본인 명의 집에 거주하고 있습니다."),
      moneyField("homeValue", "집 시세", "재산", 6500, "집 추정 시세는 65,000천원입니다."),
    ],
    supportType: "개인워크아웃",
  }),
  caseData({
    ...
    fields: [
      ...
      moneyField("unsecuredDebt", "신용채무", "채무현황", 5500, "신용채무는 55,000천원입니다."),
      moneyField("securedDebt", "담보채무", "채무현황", 6000, "주택담보대출은 60,000천원 남아 있습니다."),
  ...
  caseData({
    ...
    fields: [
      ...
      moneyField("unsecuredDebt", "신용채무", "채무현황", 6000, "신용채무는 60,000천원입니다."),
      moneyField("securedDebt", "담보채무", "채무현황", 9000, "전세담보대출은 90,000천원 남아 있습니다."),
  ...
  caseData({
    ...
    scenario: [
      ...
      "신용채무는 45,000천원입니다.",
      "담보채무는 없습니다.",
      "보증금 30,000천원에 월세 1,000천원으로 살고 있습니다.",
      "본인 명의 차량 한 대가 있습니다.",
      "차량 추정 시세는 12,000천원입니다.",
    ],
    ...
    fields: [
      ...
      moneyField("unsecuredDebt", "신용채무", "채무현황", 4500, "신용채무는 45,000천원입니다."),
      moneyField("securedDebt", "담보채무", "채무현황", 0, "담보채무는 없습니다."),
      housingField("임차", "보증금 30,000천원에 월세 1,000천원으로 살고 있습니다."),
      moneyField("deposit", "보증금", "주거", 3000, "보증금 30,000천원에 월세 1,000천원으로 살고 있습니다."),
      moneyField("monthlyRent", "월세", "주거", 100, "보증금 30,000천원에 월세 1,000천원으로 살고 있습니다."),
      booleanField("hasVehicle", "차량", "재산", "본인 명의 차량 한 대가 있습니다."),
      moneyField("vehicleValue", "차량 시세", "재산", 1200, "차량 추정 시세는 12,000천원입니다."),
    ],
    supportType: "사전채무조정",
